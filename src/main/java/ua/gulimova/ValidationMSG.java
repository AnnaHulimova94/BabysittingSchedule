...
public class ValidationMSG {
    ...
    public static final String MSG_PHONE_DUPLICATE = "Phone number is already in use";
    public static final String MSG_PHONE_INVALID = "Phone number is not correct";
    public static final String PATTERN_PHONE = "\\+([0-9]{12})";
